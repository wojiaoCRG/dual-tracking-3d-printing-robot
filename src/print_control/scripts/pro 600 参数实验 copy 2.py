...
try:
    ...
    while z_movement < 13:  # 直到Y轴移动总量达到20mm
        ...
        robot.write_coords([stop_coords[0],stop_coords[1],stop_coords[2]+z_movement,stop_coords[3],stop_coords[4],stop_coords[5]],speed)
        robot.command_wait_done()
        ...
        robot.write_coords([start_coords[0],start_coords[1],start_coords[2]+z_movement,start_coords[3],start_coords[4],start_coords[5]],speed)
        robot.command_wait_done()
